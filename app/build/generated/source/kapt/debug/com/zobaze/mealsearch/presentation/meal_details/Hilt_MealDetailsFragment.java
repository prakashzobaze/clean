...
public abstract class Hilt_MealDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MealDetailsFragment() {
    super();
  }

  Hilt_MealDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MealDetailsFragment_GeneratedInjector) this.generatedComponent()).injectMealDetailsFragment(UnsafeCasts.<MealDetailsFragment>unsafeCast(this));
    }
  }
