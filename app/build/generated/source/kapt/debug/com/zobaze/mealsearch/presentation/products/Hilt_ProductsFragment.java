...
public abstract class Hilt_ProductsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductsFragment_GeneratedInjector) this.generatedComponent()).injectProductsFragment(UnsafeCasts.<ProductsFragment>unsafeCast(this));
    }
  }
