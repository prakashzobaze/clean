...
public abstract class Hilt_MealSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MealSearchFragment() {
    super();
  }

  Hilt_MealSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MealSearchFragment_GeneratedInjector) this.generatedComponent()).injectMealSearchFragment(UnsafeCasts.<MealSearchFragment>unsafeCast(this));
    }
  }
