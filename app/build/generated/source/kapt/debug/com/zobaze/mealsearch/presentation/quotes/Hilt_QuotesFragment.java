...
public abstract class Hilt_QuotesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuotesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuotesFragment_GeneratedInjector) this.generatedComponent()).injectQuotesFragment(UnsafeCasts.<QuotesFragment>unsafeCast(this));
    }
  }
