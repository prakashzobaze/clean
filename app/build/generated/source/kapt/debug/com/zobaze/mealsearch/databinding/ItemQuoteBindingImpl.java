...
public class ItemQuoteBindingImpl extends ItemQuoteBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.quote == variableId) {
            setQuote((com.zobaze.mealsearch.domain.model.Quote) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setQuote(@Nullable com.zobaze.mealsearch.domain.model.Quote Quote) {
        this.mQuote = Quote;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.zobaze.mealsearch.domain.model.Quote quote = mQuote;
