...
public abstract class Hilt_UsersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UsersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UsersFragment_GeneratedInjector) this.generatedComponent()).injectUsersFragment(UnsafeCasts.<UsersFragment>unsafeCast(this));
    }
  }
